...
def sendEmailBackend(sender_address = 'hoangkimmanhha2@gmail.com',
    ...
    try:
        ...
        messagebox.showerror(title='EduQuest',message='Lỗi email! Vui lòng kiểm tra lại!')

import image
def main(s_email:str = 'minneeeeee68@gmail.com',
         r_email:list = ['nguyentranbaokhanh112@gmail.com'],
...
if __name__ == "__main__":
    header = sys.argv
    main(s_email=header[1],r_email=literal_eval('['+','.join(map(lambda x:f"'{x}'",header[2:len(header)-1]))+']'),sender_passw=header[3])